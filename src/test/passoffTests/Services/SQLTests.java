...
public class SQLTests {
    ...
    public void negativeJoinGame() throws DataAccessException, SQLException {
        ...
        assertNull(resultMessage, "Request returned incorrect message");
    }
    ...
    public void positiveListGames() throws DataAccessException, SQLException {
        ...
        assertEquals(expectedList.size(), listGamesResult.getGames().size(), "List returned not same as expected");
    }
