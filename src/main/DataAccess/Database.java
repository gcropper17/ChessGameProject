...
public class Database {
    ...
    private static final String DB_PASSWORD = "Dentdank7$";
     ...
     * @return Connection
     */
    synchronized static public Connection getConnection() throws DataAccessException {
        try {
     ...
     */
    synchronized public static void returnConnection(Connection connection) {
